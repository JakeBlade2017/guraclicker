...
> [Autoplay availability](https://developer.mozilla.org/en-US/docs/Web/Media/Guides/Autoplay#autoplay_availability)\
> [The Embed Audio element](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/audio)
